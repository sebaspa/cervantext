        ...
        <div class="py-5 px-7 mb-5 bg-white rounded-lg transition duration-300">
            ...
            <div class="hidden response-content">
                <p class="text-base font-lato text-gray-300">
                    Una pieza puede ser cualquier tipo de contenido. Una entrada de tu blog, una edición de tu newsletter, una parte de un ebook más largo...Adaptamos nuestros planes a tu estrategia de contenido. Todas incluyen al menos una ilustración o infografía original.
                </p>
            </div>
        </div>
